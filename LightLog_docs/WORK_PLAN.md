...
### 4.1 일기 작성 기능
- [ ] `DiaryWriteScreen`: 일기 작성 화면 UI 및 기능 구현
  - [ ] 텍스트 입력, 저장, 수정, 삭제 기능
  - [ ] 작성 날짜 선택 기능
  - [ ] 임시 저장 기능 (선택사항)

### 4.2 달력 기반 일기 조회
- [ ] `CalendarScreen`: 달력 UI 및 데이터 연동 기능 구현
  - [ ] 월별 달력 뷰에서 일기 작성된 날짜 표시
  - [ ] 특정 날짜 클릭 시 해당 일기 조회
  - [ ] 월/년도 네비게이션 기능

### 4.3 과거 일기 빠른 조회 기능
- [ ] 백엔드: 과거 일기 조회 API 구현
  - [ ] 1개월 전 같은 날 일기 조회 API
  - [ ] 3개월 전 같은 날 일기 조회 API  
  - [ ] 6개월 전 같은 날 일기 조회 API
  - [ ] 1년 전 같은 날 일기 조회 API
- [ ] 프론트엔드: 과거 일기 조회 UI 구현
  - [ ] 메인 화면에 "과거의 오늘" 섹션 추가 (있는 경우에만 표시)
  - [ ] 과거 일기 상세 보기 화면
  - [ ] 과거 일기 리스트 화면 (타임라인 형태)
